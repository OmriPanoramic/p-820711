...
>(({ className, thumbClassName, renderThumb, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="relative h-6 w-6 focus:outline-none">
      <svg
        width="72"
        height="72"
        viewBox="0 0 72 72"
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_57_7005"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_57_7005"
              result="shape"
            />
          </filter>
        </defs>
