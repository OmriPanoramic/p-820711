...
export const PricingCalculator = () => {
    ...
    return (
        <div className="flex flex-col items-center w-[1440px] max-w-full px-5 pb-20">
            <div className="flex w-full gap-20 max-md:flex-col">
                <div className="flex-1">
                    <PricingFeatures />
                </div>
                <div className="w-[600px] shrink-0">
                    <div className="w-full flex flex-col items-start rounded-xl border border-[#FFEDD4] bg-white shadow-[0px_-2px_8px_-1px_rgba(23,23,23,0.04),0px_14px_40px_-4px_rgba(23,23,23,0.06)] overflow-hidden">
        ...
        <div className="mt-6">
            <div className="flex flex-col">
                <div className="flex items-baseline">
                    ...
                    <span
                        className="text-[#222] text-[16px] font-normal leading-[150%] ml-1"
                ...
                <div className="flex items-center gap-1">
                    <span className="text-[#909090] text-[16px] font-normal leading-[140%]">
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent side="bottom" className="max-w-[322px] text-[16px]">
...
const PricingConfigurator = ({
    ...
    <div className="flex-1">
        <div className="w-[844px] flex flex-col items-start rounded-xl border border-[#FFEDD4] bg-white shadow-[0px_-2px_8px_-1px_rgba(23,23,23,0.04),0px_14px_40px_-4px_rgba(23,23,23,0.06)] overflow-hidden">
            <ConfigurationSection
                sites={sites}
                setSites={setSites}
                inputs={inputs}
...
const FeatureList = ({ features }: { features: readonly string[] }) => (
    <div className="mt-8">
        <div className="text-[20px] font-medium text-[#171717] mb-5">
            Included features:
        </div>
        <div className="space-y-4">
            {features.map((feature) => (
                <div key={feature} className="flex items-center gap-4">
                    ...
                    <span className="text-[16px] leading-5 text-[#171717] font-normal">
                        {feature}
                    </span>
                </div>
            ))}
...
const ConfigurationSection = ({
    ...
    return (
        <div className="flex flex-col w-full">
            {/* Header */}
            <h3
                className="text-[20px] font-semibold text-[#222] font-jakarta leading-[150%] p-8"
                style={{ fontFeatureSettings: "'liga' off, 'calt' off" }}
            >
                Configure your plan
            </h3>
