                ...
                <div className="flex-1">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="space-y-3">
                            {["Advanced optimization tools", "Team collaboration", "Priority support", "Data export included", "Reports included", "Custom dashboards"].map(feature => (
                                <div key={feature} className="flex items-center gap-2">
                                    <img
                                        src="https://cdn.builder.io/api/v1/image/assets/4b8bee12bead4b66b573187d8e419c5d/aee02f786175f73269924ea5986d4a4f1ba8cf1583827e54d4eccfe46315e209"
                                        alt=""
                                        className="w-5 h-5"
                                    />
                                    <span>{feature}</span>
