...
export const PricingCalculator = () => {
    ...
    const discountedMonthlyPrice = totalMonthlyPrice * PRICING_CONFIG.ANNUAL_DISCOUNT;
        ...
        <div className="mt-6">
            <div className="flex flex-col">
                <div className="flex items-baseline">
                    ...
                    <span className="text-[#222] text-[14px] font-normal leading-[150%] ml-1" style={{ fontFeatureSettings: "'liga' off, 'calt' off" }}>
                ...
                <div className="flex items-center gap-1">
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <svg width="14" height="14" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#909090] mt-1">
                                <path d="M6 1C3.2385 1 1 3.2385 1 6C1 8.7615 3.2385 11 6 11C8.7615 11 11 8.7615 11 6C11 3.2385 8.7615 1 6 1ZM6.6 8.5H5.4V5.5H6.6V8.5ZM6.6 4.5H5.4V3.5H6.6V4.5Z" fill="currentColor"/>
                            </svg>
                        </TooltipTrigger>
                        <TooltipContent side="bottom" className="max-w-[280px]">
                            For multi-sites, where some or all sites are billed together (same renewal date) the min $50/month is on the combined sites (not per site)
                        </TooltipContent>
                    </Tooltip>
                </div>
            </div>
                ...
                <div key={feature} className="flex items-center gap-4">
                    <div className="flex h-6 w-6 items-center justify-center rounded-[100px] border border-[rgba(34,34,34,0.10)]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path d="M6.36689 11.9999L2.56689 8.19994L3.51689 7.24994L6.36689 10.0999L12.4836 3.98328L13.4336 4.93328L6.36689 11.9999Z" fill="#222222"/>
                        </svg>
                    </div>
                    <span className="text-sm leading-5 text-[#171717] font-normal">{feature}</span>
                </div>
            ))}
        </div>
...
const ConfigurationSection = ({
    ...
    return (
        <div className="flex flex-col w-full">
            {/* Header */}
            <h3 className="text-[16px] font-semibold text-[#222] font-jakarta leading-[150%] p-8" 
