        ...
        <div className="w-full">
          <header className="flex w-full items-center gap-[16px] text-2xl text-[rgba(34,34,34,1)] font-medium whitespace-nowrap leading-[1.3]">
            <img
                loading="lazy"
                src={icon}
                className="aspect-[1] object-contain w-[80px] self-stretch shrink-0 my-auto rounded-[10px]"
                alt={`${title} icon`}
            />
              ...
              <div className="w-full mt-5">
                <div className="flex w-full gap-2 flex-wrap">
                  <div className="flex min-w-60 gap-1 text-[#222] flex-wrap flex-1 shrink basis-[0%] items-end">
                    ...
                    <span className="text-sm font-normal ml-1">{priceSubtext}</span>
                  </div>
                  {minPrice && (
                      <div className="text-[#6D6D6D] text-sm font-normal">{minPrice}</div>
                  )}
                </div>
