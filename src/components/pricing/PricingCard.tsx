...
export const PricingCard = ({
  ...
  return <article className={`border w-full p-8 rounded-xl ${cardClasses} ${className}`}>
        <div className="w-full">
          <header className="flex w-full items-center gap-[16px] text-2xl text-[rgba(34,34,34,1)] font-medium whitespace-nowrap leading-[1.3]">
            <img loading="lazy" src={icon} className="aspect-[1] object-contain w-[80px] self-stretch shrink-0 my-auto rounded-[10px]" alt={`${title} icon`} />
          ...
          {price && <div className="w-full mt-5">
                ...
                {variant === "primary" && <div className="bg-[rgba(37,31,31,0.04)] border flex min-h-12 w-full items-center gap-3 text-base flex-wrap mt-4 pl-3 pr-4 py-3 rounded-lg border-[rgba(37,31,31,0.08)]">
                      <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/4b8bee12bead4b66b573187d8e419c5d/eefecd56a897a32835976d67c57d09015a18ddd1b5685d7a336048586db07823" className="aspect-[1] object-contain w-6 self-stretch shrink-0 my-auto" alt="" />
        ...
        <div className="w-full mt-8 pb-2">
          {features.map((feature, index) => <div key={index} className={index > 0 ? "mt-5" : ""}>
                ...
                {feature.subFeatures && <div className="pl-6 text-gray-500 text-sm mt-1">
                      {feature.subFeatures.map((subFeature, subIndex) => <div key={subIndex} className="flex items-center gap-2">
                            <span>•</span>
